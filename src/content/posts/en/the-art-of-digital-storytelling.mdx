...
import diagramImage from '@assets/images/blog/digital-storytelling.jpg';
...
<Image src={diagramImage} alt="A diagram showing the lifecycle of a web application from planning to deployment." class="rounded-lg shadow-md" />
